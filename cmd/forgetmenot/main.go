...
func main() {
	...
	var (
		...
		llmKind     = flag.String("llm", "", "chat provider for auto-topics/summarize: ollama | openai | anthropic (empty disables)")
		llmURL      = flag.String("llm-url", "", "chat endpoint base URL")
		llmModel    = flag.String("llm-model", "", "chat model name")
		llmAPIKey   = flag.String("llm-api-key", "", "API key for the chat provider")
